 ...
 */
public class RSSReaderSpeechlet implements SpeechletV2 {
    private static final Logger log = LoggerFactory.getLogger(RSSReaderSpeechlet.class);
    ...
    private SpeechletResponse getWelcomeResponse() {
        ...
        return getAskResponse("RSSReader", speechText);
    }
    ...
    private SpeechletResponse getHelloResponse() {
        String speechText = "Hello Mishika";
