...
public class HistoryBuffSpeechlet implements SpeechletV2 {
    ...
    public SpeechletResponse onIntent(SpeechletRequestEnvelope<IntentRequest> requestEnvelope) {
        ...
        if ("GetFirstEventIntent".equals(intentName)) {
            ...
            String speechOutput =
                    "Vikas With History Buff, you can get"
            ...
            String repromptText = "Vikas Which day do you want?";

            return newAskResponse(speechOutput, false, repromptText, false);
        } else if ("AMAZON.StopIntent".equals(intentName)) {
            PlainTextOutputSpeech outputSpeech = new PlainTextOutputSpeech();
            outputSpeech.setText("Goodbye Vikas");
            ...
            String outputSpeech = "Sorry Vikas, I didn't get that.";
            String repromptText = "Vikas What day do you want events for?";
    ...
    private SpeechletResponse getWelcomeResponse() {
        String speechOutput = "History buff. Vikas. What day do you want events for?";
        // If the user either does not reply to the welcome message or says something that is not
        // understood, they will be prompted again with this text.
        String repromptText =
                "Vikas With History Buff, you can get historical events for any day of the year. "
    ...
    private SpeechletResponse handleFirstEventRequest(SpeechletRequestEnvelope<IntentRequest> requestEnvelope) {
        ...
        dispatchProgressiveResponse(request.getRequestId(), "Vikas i am Searching", systemState, apiEndpoint);

        ArrayList<String> events = getJsonEventsFromWikipedia(month, date);
        String speechOutput = "";
        if (events.isEmpty()) {
            speechOutput =
                    "Vikas There is a problem connecting to Wikipedia at this time."
    ...
    private SpeechletResponse handleNextEventRequest(Session session) {
        ...
        if (events == null) {
            ...
            speechOutput =
                    "Vikas There are no more events for this date. Try another date by saying, "
            ...
            if (index < events.size()) {
                speechOutputBuilder.append(" Vikas Wanna go deeper in history?");
                cardOutputBuilder.append(" Vikas Wanna go deeper in history?");
            }
            session.setAttribute(SESSION_INDEX, index);
            speechOutput = speechOutputBuilder.toString();
            cardOutput = cardOutputBuilder.toString();
        }
        String repromptText = "Vikas Do you want to know more about what happened on this date?";
